var OPENAI_API_KEY = "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";
...
function ChangeLang(o) {
  if (oSpeechRecognizer) {
    oSpeechRecognizer.lang = selLang.value; //SpeechToText()
  }
}
...
function TextToSpeech(s) {
  ...
  oSpeechSynthesisUtterance.text = s; //Uncaught (in promise) Error: A listener indicated an //asynchronous response by returning true, but the message channel closed
